...
CREATE TABLE IF NOT EXISTS items(id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY, owner_id INT REFERENCES users(id), name VARCHAR(255), description VARCHAR(255), available BOOLEAN);
